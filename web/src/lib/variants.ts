 ...
 * Shared variant-groups.json fixtures enforce agreement with backend pagination. */
...
export function variantOptions(files: LibraryFile[]): { value: string; label: string }[] {
