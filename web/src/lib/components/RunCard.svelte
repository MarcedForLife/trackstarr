	...
	<div class="flex items-baseline gap-2.5">
		...
		{:else if stoppable}
			...
			<button
				...
				class="relative -my-1 flex-none rounded-md border border-line-strong px-2 py-1 text-[11.5px] leading-none font-medium text-dim transition-colors after:absolute after:-inset-3 after:content-[''] hover:border-danger/45 hover:text-danger active:bg-danger/10 disabled:opacity-(--disabled)"
			>
